 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let v;!function(e){e.SMALL="sm",e.MEDIUM="md",e.LARGE="lg"}(v||(v={}));let f,m,h,y,_,x=e=>e;s([g(`${i}-pagination`)],(function(o,s){return{F:class extends s{constructor(...e){super(...e),o(this)}},d:[{kind:"field",decorators:[c(`${i}-select`)],key:"_pageSizeSelect",value:void 0},{kind:"method",key:"_handleSlotChange",value:function({target:e}){e.assignedNodes().filter((e=>e.nodeType!==Node.TEXT_NODE||e.textContent.trim())).forEach((e=>{this._pageSizeSelect.appendChild(e)}))}},{kind:"method",key:"_renderStatusText",value:function(){const{start:e,pageSize:t,totalItems:o,pagesUnknown:s,formatStatusWithDeterminateTotal:n,formatStatusWithIndeterminateTotal:i}=this;return(null==o||s?i:n)({start:e+1,end:Math.min(e+t,null==o?1/0:o),count:o})}},{kind:"method",key:"_handleUserInitiatedChangeStart",value:function(e){this.start=e,this.dispatchEvent(new CustomEvent(this.constructor.eventChangeCurrent,{bubbles:!0,composed:!0,detail:{page:this.page,pageSize:this.pageSize}}))}},{kind:"method",key:"_handleClickPrevButton",value:function(){const{start:e,pageSize:t}=this;this.page--;const o=Math.max(e-t,0);o!==e&&this._handleUserInitiatedChangeStart(o)}},{kind:"method",key:"_handleClickNextButton",value:function(){const{start:e,pageSize:t,totalItems:o}=this;this.page++;const s=e+t;s<(null==o?1/0:o)&&this._handleUserInitiatedChangeStart(s)}},{kind:"method",decorators:[b("eventChangeSelect")],key:"_handleChangeSelector",value:function(e){const{value:t}=e.detail,{totalItems:o,pageSize:s}=this;e.composedPath()[0]===this._pageSizeSelect?(this.pageSize=parseInt(t),this.totalPages=s>0?Math.ceil(o/s):o,this.page=1,this.start=0):(this.page=t,this._handleUserInitiatedChangeStart((t-1)*s))}},{kind:"field",decorators:[a({attribute:"backward-text"})],key:"backwardText",value:()=>"Previous page"},{kind:"field",decorators:[a({type:Number,reflect:!0})],key:"page",value:()=>1},{kind:"field",decorators:[a({attribute:!1})],key:"formatLabelText",value:()=>({count:e})=>`Page number, of ${e} page${e<=1?"":"s"}`},{kind:"field",decorators:[a({attribute:!1})],key:"formatStatusWithDeterminateTotal",value:()=>({start:e,end:t,count:o})=>`${e}–${t} of ${o} item${o<=1?"":"s"}`},{kind:"field",decorators:[a({attribute:!1})],key:"formatStatusWithIndeterminateTotal",value:()=>({start:e,end:t,count:o})=>null==t?`Item ${e}–`:`${e}–${t} item${o<=1?"":"s"}`},{kind:"field",decorators:[a({attribute:!1})],key:"formatSupplementalText",value(){return({count:e})=>this.pagesUnknown||!this.totalItems?"page":`of ${e} page${e<=1?"":"s"}`}},{kind:"field",decorators:[a({type:Boolean,attribute:"is-last-page"})],key:"isLastPage",value:void 0},{kind:"field",decorators:[a({attribute:"items-per-page-text"})],key:"itemsPerPageText",value:()=>"Items per page:"},{kind:"field",decorators:[a({type:Boolean,reflect:!0})],key:"disabled",value:()=>!1},{kind:"field",decorators:[a({attribute:"forward-text"})],key:"forwardText",value:()=>"Next page"},{kind:"field",decorators:[a({attribute:"page-input-disabled"})],key:"pageInputDisabled",value:void 0},{kind:"field",decorators:[a({type:Number,attribute:"page-size",reflect:!0})],key:"pageSize",value:()=>10},{kind:"field",decorators:[a({type:Boolean,attribute:"page-size-input-disabled"})],key:"pageSizeInputDisabled",value:void 0},{kind:"field",decorators:[a({attribute:"page-size-label-text"})],key:"pageSizeLabelText",value:void 0},{kind:"field",decorators:[a({type:Boolean,reflect:!0,attribute:"pages-unknown"})],key:"pagesUnknown",value:()=>!1},{kind:"field",decorators:[a({reflect:!0})],key:"size",value:()=>v.MEDIUM},{kind:"field",decorators:[a({type:Number})],key:"start",value:()=>0},{kind:"field",decorators:[a({type:Number,attribute:"total-items"})],key:"totalItems",value:void 0},{kind:"field",decorators:[a({type:Number})],key:"totalPages",value:()=>1},{kind:"method",key:"updated",value:function(e){const{page:t,pageSize:o,totalItems:s}=this,{selectorPageSizesSelect:n,selectorPagesSelect:i}=this.constructor;e.has("pageSize")&&(this.shadowRoot.querySelector(n).value=o),(e.has("pageSize")||e.has("start"))&&(this.totalPages=o>0?Math.ceil(s/o):s,this.shadowRoot.querySelector(i).value=this.page.toString()),e.has("page")&&this._handleUserInitiatedChangeStart((t-1)*o)}},{kind:"method",key:"render",value:function(){const{page:e,disabled:o,forwardText:s,backwardText:r,itemsPerPageText:a,pageInputDisabled:c,pageSize:l,pageSizeInputDisabled:p,pagesUnknown:b,size:g,start:u,totalItems:v,totalPages:k,_handleClickPrevButton:z,_handleClickNextButton:w,_handleSlotChange:$,formatLabelText:S,formatSupplementalText:q}=this,{isLastPage:j=u+l>=v}=this,C=o||0===u,I=o||j,T={[`${i}--btn`]:!0,[`${i}--btn--icon-only`]:!0,[`${i}--pagination__button`]:!0,[`${i}--pagination__button--backward`]:!0,[`${i}--pagination__button--no-index`]:C,[`${i}--btn--${g}`]:!0,[`${i}--btn--ghost`]:!0},M={[`${i}--btn`]:!0,[`${i}--btn--icon-only`]:!0,[`${i}--pagination__button`]:!0,[`${i}--pagination__button--forward`]:!0,[`${i}--pagination__button--no-index`]:I,[`${i}--btn--${g}`]:!0,[`${i}--btn--ghost`]:!0},P=Object.entries(T).filter((([,e])=>!0===e)).map((([e])=>e)).join(" "),B=Object.entries(M).filter((([,e])=>!0===e)).map((([e])=>e)).join(" ");return n(f||(f=x`
    ...
    `),i,i,a,o||p,g,l,$,i,i,this._renderStatusText(),i,i,i,S({count:k}),b||!v?n(m||(m=x`
              <span
            ...
            `),i,i,q({count:k}),o||c,g,e,Array.from(new Array(k)).map(((e,t)=>n(h||(h=x`
              ...
              <span class="${0}--pagination__text"
                >${0}</span
              >
            `),o||c,g,e,Array.from(new Array(k)).map(((e,t)=>n(_||(_=x`
                      <cds-select-item value="${0}">
                        ${0}
                      </cds-select-item>
                    `),t+1,t+1))),i,q({count:k})),i,g,C,P,r,z,(({children:e,...o}={})=>t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${d(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${e}<path d="M20 24L10 16 20 8z"></path></svg>`)({slot:"icon"}),g,I,B,s,w,(({children:e,...o}={})=>t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${d(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${e}<path d="M12 8L22 16 12 24z"></path></svg>`)({slot:"icon"}))}},{kind:"get",static:!0,key:"selectorPagesSelect",value:function(){return`${i}-select#pages-select`}},{kind:"get",static:!0,key:"selectorPageSizesSelect",value:function(){return`${i}-select`}},{kind:"get",static:!0,key:"eventChangeCurrent",value:function(){return`${i}-pagination-changed-current`}},{kind:"get",static:!0,key:"eventChangeSelect",value:function(){return`${i}-select-selected`}},{kind:"field",static:!0,key:"shadowRootOptions",value:()=>e(e({},r.shadowRootOptions),{},{delegatesFocus:!0})},{kind:"field",static:!0,key:"styles",value:()=>u}]}}),l(p(r)));
