...
declare const CDSTurnStatusIndicator_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSTurnStatusIndicator extends CDSTurnStatusIndicator_base {
    /**
    ...
    statusText: string;
    date: string;
    renderStatusIcon(statusIcon: string): string;
